...
class CommerceLab_Mcenter_Model_Mysql4_Category_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract{
    ...
    */
    ...
    public function lookupStoreIds($objectId)
    {
        ...
        $tableName = Mage::getSingleton('core/resource')->getTableName('clmcenter_category_store');
