    ...
    jQuery(function(jQuery){
        ...
        jQuery('.main').append('<div id="resultLoading" style="display:none"><div><img src="http://ortodon.ru/media/magehouse/slider/default/ajax-loader.gif"><div>Fetching Results... Please wait...</div></div><div class="bg"></div></div>');}
